...
abstract class BaseSource
{
    ...
    public abstract bool CanHandle(Uri uri, [NotNullWhen(true)] out Uri? normalizedUri, [NotNullWhen(true)] out string? prefix);
    public abstract Task Load(Uri uri, DispatcherQueue mainDispatcherQueue);
